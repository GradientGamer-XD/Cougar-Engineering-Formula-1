#  COUGAR ENGINEERING: Formula 1

Formula 1 is a fork of Project Modulux, an elevator engine on roblox for Cougar Engineering Elevator and further more.

Modulux is GPL Licensed and thus this fork inherits such license
...
### Disclaimer
This software is provided "as is," without warranty of any kind. For the full legal terms, please see the [LICENSE](LICENSE) file in this repository or visit the [official GNU website](https://www.gnu.org.html).
